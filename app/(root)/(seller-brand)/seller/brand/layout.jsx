'use client'
import BrandSellerSidebar from '@/components/Application/seller/BrandSellerSidebar'
...
const BrandSellerLayout = ({ children }) => {
            ...
            <SidebarProvider>
                <div className="flex h-screen w-full overflow-hidden">
                    ...
                    <SidebarInset className="flex-1 flex flex-col overflow-auto">
                        <SellerTopbar sellerType="brand" />
                        <main className="flex-1 overflow-auto pt-14 px-4 md:px-6">{children}</main>
                        <footer className='border-t h-10 flex justify-center items-center gap-2 bg-gray-50 dark:bg-background text-sm'>
...
export default BrandSellerLayout