...
const breadcrumb = { title: 'Privacy Policy', links: [{ label: 'Privacy Policy' }] }
...
const PrivacyPolicy = () => {
    ...
    const fetchContent = async () => {
        try {
            const { data } = await axios.get('/api/content/privacy-policy')
            ...
            <div className='lg:px-40 px-5 py-20'>
                {loading ? <div className="text-center py-10">Loading...</div> : content ? (
                    ...
                    <div>
                        ...
                        <p>We value your privacy. Your data is safe with ThriftYatra.</p>
                    </div>
                )}
            </div>
        </div>
